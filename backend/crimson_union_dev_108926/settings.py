"""
Django settings for crimson_union_dev_108926 project.
...
ROOT_URLCONF = 'crimson_union_dev_108926.urls'
...
WSGI_APPLICATION = 'crimson_union_dev_108926.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_union_dev_108926 API",
    "DESCRIPTION": "API documentation for crimson_union_dev_108926 App",
    "VERSION": "v1",
}
